   ...
   public void setEtiqueta(String etiqueta) {
    ...
    public String getPostbyte() {
        ...
        if(DirAux.equalsIgnoreCase("IDX2") && codop.equalsIgnoreCase(BD.PosicionMatriz(i, 0)) && BD.PosicionMatriz(i, 3).contains("xb ee ff")) {
            ...
            FormaXB9 = FormaXB9.replace("z","1"); //Reemplazar z por 0 en la forma
            ...
            ValorFF = String.format("%02x", ValorDecimal).toUpperCase(); //Colocar formato de dos digitos (rellenar con 0 en caso de)
        ...
        if (codop.equalsIgnoreCase("DS.B") && codop.equalsIgnoreCase(BD.PosicionMatriz(i, 0))) {
            if(!operando.matches("\\d+")) { //Validar si el operando es un numero decimal 
                operando = "Error OPR";
                tamaño = "0";
                return ("Error Postbyte");
            } //Fin de validar si el operando esta bien
